...
- [ ] Describe Middleware?
    * Used to to get the request and response objects and the next middleware function. 
- [ ] Describe a Resource?
   * The items that our application cares about (nouns) 
- [ ] What can the API return to help clients know if a request was successful?
* Status codes and response messages 
- [ ] How can we partition our application into sub-applications?
 * Through the use of the .env file and dependencies.
